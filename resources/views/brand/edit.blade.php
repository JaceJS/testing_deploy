...
@section('content')    
    <div class="container-fluid px-4">
        <h2 class="my-4">Edit Brands</h2>
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('brand.update', $brands->id) }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                    @csrf
                    @method('PUT')
